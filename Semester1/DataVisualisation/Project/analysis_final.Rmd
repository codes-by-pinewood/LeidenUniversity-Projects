...
ggplot(total, aes(x = 
                    reorder(x=geo,
                            X=price_levels),
                            y=price_levels, 
                            fill=regions)) +  labs(x = "Price levels", y = "Countries", fill = "REGION", caption="A plot of the price levels of various European countries separated by region")+
  geom_bar(stat = "summary", fun="mean") + coord_flip() +  theme_minimal() 
...
ggplot(total, aes(x = 
                    reorder(x=geo,
                            X=GDP),
                            y=GDP, 
                            fill=regions)) +  labs(x = "Gross Domestic Product", y = "Countries", fill = "REGION", caption="A plot of the GDP of various European countries separated by region") + geom_bar(stat = "identity") + coord_flip() +  theme_minimal() 

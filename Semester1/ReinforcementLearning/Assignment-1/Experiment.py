...
def average_over_repetitions(backup, n_repetitions, n_timesteps, max_episode_length, learning_rate, gamma, policy='egreedy', 
    ...
    print(f'returns over reps: {len(returns_over_repetitions)}')
    ...
    print('---------------------------------------')
    print(f'episilon: {epsilon}, LC shape: {len(learning_curve)}, timesteps: {len(timesteps)}, nsteps : {n}')
    print('---------------------------------------')
...
def experiment():
    ...
    optimal_episode_return = 83.8 # set the optimal return per episode you found in the DP assignment here
    ...
    for epsilon in epsilons: 
        print("{} epsilon: {}".format(itr, epsilon))   
        itr = itr + 1   
